...
apt install -y gimp keepass2 keepassx printer-driver-hpijs secure-delete vlc xdotool google-chrome-stable git cubic syslinux-utils skype libxcb-xtest0 libdvd-pkg
